...
*/
    ...
    //
    {
        ...
        f32 A1 = COSINE( ((X / Q1) + (m_Seconds / Q2)) * 6.00f );
        f32 A2 = SINE  ( ((Y / Q1) + (m_Seconds / Q2)) * 6.28f );
        ...
        pV->RGBA1a.R = pV->RGBA1a.G = pV->RGBA1a.B = 1.0f;
        pV->RGBA1b.R = pV->RGBA1b.G = pV->RGBA1b.B = 1.0f;
    }
}
