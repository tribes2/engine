...
LightManager::LightManager()
{
   ...
   Con::addCommand("resetLighting", cResetLighting, "resetLighting();", 1, 1);
}
...
void LightManager::registerLights(bool lightingScene)
{
   ...
   // walk the lightlist and query objects for theirg lights
...
void LightManager::installGLLight(LightInfo * lightInfo)
{
   ...
   switch(lightInfo->mType)
   {
      ...
      case LightInfo::Point:
         ...
         glLightf(light, GL_LINEAR_ATTENUATION, 1 / lightInfo->mRadius);
