...
//------------------------------------------------------------------------------
static void cSetPowerAudioProfiles(SimObject *, S32, const char ** argv)
{
...
void AmbientAudioManager::consoleInit()
{
   Con::addCommand("setPowerAudioProfiles",  cSetPowerAudioProfiles, "setPowerAudioProfiles(powerUp, powerDown)",    3, 3);
}
...
void AmbientAudioManager::updateEnvironment()
{
   ...
   else
   {
      ...
      Point3F pos;
      alxGetListener3f(AL_POSITION, &pos.x, &pos.y, &pos.z);
