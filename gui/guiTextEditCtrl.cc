...
void GuiTextEditCtrl::consoleInit()
{
}
...
void GuiTextEditCtrl::onRender(Point2I offset, const RectI & /*updateRect*/, GuiControl *firstResponder)
{
   ...
   DrawText( ctrlRect, ( firstResponder == this ) );
...
{
   argc; argv;
   return( static_cast<GuiTextEditCtrl*>( object )->getCursorPos() );
}

ConsoleMethod( GuiTextEditCtrl, setCursorPos, void, 3, 3, "textEditCtrl.setCursorPos( newPos )" )
{
   argc;
   static_cast<GuiTextEditCtrl*>( object )->reallySetCursorPos( dAtoi( argv[2] ) );
}
