...
void TSPartInstance::updateBounds()
{
   ...
   Box3F bounds;
   mBounds.min.set( 10E30, 10E30, 10E30);
   mBounds.max.set(-10E30,-10E30,-10E30);
...
{
   AssertFatal((TextureObject*)mSourceShape->mEnvironmentMap,"TSPartInstance::renderEnvironmentMap (1)");
...
S32 TSPartInstance::getDetailSize(S32 dl)
{
   if (dl<0)
      return 0;
